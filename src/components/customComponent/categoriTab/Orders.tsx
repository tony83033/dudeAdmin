        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                {order.createdAt ? format(new Date(order.createdAt), 'MMM dd, yyyy • HH:mm') : 'Invalid Date'}
              </CardDescription>
            </div>
          </div>
          <div className="flex items-center gap-2">
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium">
                          {selectedOrder.userDetails?.createdAt ? format(new Date(selectedOrder.userDetails.createdAt), 'MMM dd, yyyy') : ''}
                        </p>
                      </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {selectedOrder.createdAt ? format(new Date(selectedOrder.createdAt), 'MMM dd, yyyy • HH:mm') : ''}
                    </p>
                  </div>
                </div>
                ...
                {selectedOrder.status !== 'pending' && (
                  <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {selectedOrder.updatedAt ? format(new Date(selectedOrder.updatedAt), 'MMM dd, yyyy • HH:mm') : ''}
                      </p>
                    </div>
                  </div>
                )}
